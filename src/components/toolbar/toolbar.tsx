  ...
  return (
    <div className="h-10 shrink-0 flex items-center justify-center px-3 gap-1 bg-neutral-900 border-b border-white/5">
      <button
        onClick={() => void undo()}
        disabled={!canUndo}
        className="no-drag-region flex items-center justify-center w-7 h-7 rounded-md text-white/40 hover:text-white/80 hover:bg-white/8 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
      >
