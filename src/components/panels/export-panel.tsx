...
export const ExportPanel = () => {
  ...
  return (
    <div data-testid="export-panel" className="flex flex-col gap-2">
      ...
      <button
        type="button"
        className="mt-2 flex w-full items-center justify-center gap-2.5 rounded-xl bg-white px-4 py-3.5 text-sm font-semibold tracking-tight text-neutral-950 shadow-lg shadow-black/35 transition-[transform,box-shadow,background-color] duration-200 ease-out hover:bg-zinc-100 hover:shadow-xl hover:shadow-black/40 active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950"
      >
